...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WebServiceRegistrationJob.owner'
        db.add_column('services_webserviceregistrationjob', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True), keep_default=False)

        # Adding field 'WebServiceRegistrationJob.parent'
        db.add_column('services_webserviceregistrationjob', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['services.Service'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WebServiceRegistrationJob.owner'
        db.delete_column('services_webserviceregistrationjob', 'owner_id')

        # Deleting field 'WebServiceRegistrationJob.parent'
        db.delete_column('services_webserviceregistrationjob', 'parent_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 28, 10, 9, 10, 948128)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 28, 10, 9, 10, 948064)'}),
        ...
        'maps.contact': {
            ...
            'member_expiration_dt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 28, 10, 9, 10, 859079)'}),
        ...
        'services.webserviceregistrationjob': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['services.Service']", 'null': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'pending'", 'max_length': '10'}),
            'type': ('django.db.models.fields.CharField', [], {'max_length': '4'})
        },
        'taggit.tag': {
